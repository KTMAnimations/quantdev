...
router = APIRouter(prefix="/ideation")


@router.post("/test-signal", response_model=IdeationAnalyzeResponse)
async def test_signal(request: IdeationAnalyzeRequest) -> IdeationAnalyzeResponse:
