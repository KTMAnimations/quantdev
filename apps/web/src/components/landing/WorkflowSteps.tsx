...
import { Code2, FlaskConical, Lightbulb, Rocket, Settings2 } from "lucide-react";
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="space-y-8">
          {STEPS.map((step, index) => (
            ...
            >
              <Card className="border-border-primary hover:border-accent-primary/50 transition-all duration-300">
